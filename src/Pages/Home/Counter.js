              ...
              <div className="container  mx-auto grid">
                <div className="flex justify-around">
                  <div className="grid gap-14 mb-8 md:grid-cols-2 xl:grid-cols-4">
                    <div className="flex items-center p-4 count bg-white rounded-lg shadow-xs dark:bg-gray-800">
                    ...
                    <div className="flex items-center count  p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                    ...
                    <div className="flex items-center count p-4 px-12 bg-white rounded-lg shadow-xs dark:bg-gray-800">
